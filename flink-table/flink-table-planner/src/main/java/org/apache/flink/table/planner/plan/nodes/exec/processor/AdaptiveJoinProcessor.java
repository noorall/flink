...
public class AdaptiveJoinProcessor implements ExecNodeGraphProcessor {
    ...
    private boolean isAdaptiveBroadcastJoinEnabled(ProcessorContext context) {
        ...
        return isAdaptiveBroadcastJoinEnabled && isAdaptiveBatchJoinEnabled(context);
    }
    ...
    private boolean isAdaptiveSkewedJoinOptimizationEnabled(ProcessorContext context) {
        ...
        boolean isAdaptiveSkewedJoinOptimizationEnabled =
                tableConfig.get(
                        ...
                        != OptimizerConfigOptions.AdaptiveSkewedJoinStrategy.NONE;

        return isAdaptiveSkewedJoinOptimizationEnabled && isAdaptiveBatchJoinEnabled(context);
    }

    private boolean isAdaptiveBatchJoinEnabled(ProcessorContext context) {
