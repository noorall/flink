...
public class OptimizerConfigOptions {
    ...
    @Documentation.TableOption(execMode = Documentation.ExecMode.BATCH)
    public static final ConfigOption<AdaptiveSkewedJoinStrategy>
            TABLE_OPTIMIZER_ADAPTIVE_SKEWED_JOIN_OPTIMIZATION_STRATEGY =
                    key("table.optimizer.skewed-join-optimization.strategy")
                            .enumType(AdaptiveSkewedJoinStrategy.class)
                            .defaultValue(AdaptiveSkewedJoinStrategy.AUTO)
                            .withDescription(
                    ...
                    key("table.optimizer.skewed-join-optimization.skewed-factor")
                            ...
                            .withDescription(
                                    "During the join phase, Flink will automatically reduce the ratio of the "
                                            ...
                                            + "unless the maximum value is below the skewed-threshold. Note that "
                    ...
                    key("table.optimizer.skewed-join-optimization.skewed-threshold")
                            ...
                            .withDescription(
                                    "During the join phase, when the maximum data volume processed by a concurrent task "
                                            ...
                                            + "to less than the skewed-factor and will also achieve a more balanced data "
                                            + "distribution. Note that this optimization has additional overhead, and it "
                                            + "is not recommended to set this value to less than 256MB.  Users can adjust "
                                            + "this parameter based on the 'Read Bytes' metric. ");
    ...
    @PublicEvolving
    public enum AdaptiveSkewedJoinStrategy implements DescribedEnum {
        ...
        AdaptiveSkewedJoinStrategy(String value, InlineElement description) {
            this.value = value;
            this.description = description;
        }
