...
public class DefaultStreamGraphContext implements StreamGraphContext {
    ...
    private void modifyInterInputsKeyCorrelation(
            StreamEdge targetEdge, boolean existInterInputsKeyCorrelation) {
        if (targetEdge == null
                || targetEdge.existInterInputsKeyCorrelation() == existInterInputsKeyCorrelation) {
            return;
        }
        targetEdge.setExistInterInputsKeyCorrelation(existInterInputsKeyCorrelation);
    }
