 ...
 */
@Internal
public class TableOperatorWrapper<OP extends StreamOperator<OUT>, OUT> implements Serializable {
    ...
    private final Map<Integer, Integer> inputIdAndUnionCountMapping;
    private final Map<Integer, Integer> inputIdAndUnionCountMappingRecorder = new HashMap<>();
    ...
    public TableOperatorWrapper(
            ...
            Map<Integer, Integer> inputIdAndUnionCountMapping) {
        ...
        this.inputIdAndUnionCountMapping = checkNotNull(inputIdAndUnionCountMapping);
        inputIdAndUnionCountMapping.forEach(
                (k, v) -> inputIdAndUnionCountMappingRecorder.put(k, 0));
    }

    public void createOperator(StreamOperatorParameters<OUT> parameters) {
    ...
    public void endOperatorInput(int inputId) throws Exception {
        inputIdAndUnionCountMappingRecorder.compute(inputId, (k, v) -> v + 1);
        if (inputIdAndUnionCountMapping
                .get(inputId)
                .equals(inputIdAndUnionCountMappingRecorder.get(inputId))) {
            endedInputCount++;
        } else if (inputIdAndUnionCountMappingRecorder.get(inputId)
                > inputIdAndUnionCountMapping.get(inputId)) {
    ...
    public static class Edge implements Serializable {
        ...
        public Edge(
                TableOperatorWrapper<?, ?> source, TableOperatorWrapper<?, ?> target, int inputId) {
