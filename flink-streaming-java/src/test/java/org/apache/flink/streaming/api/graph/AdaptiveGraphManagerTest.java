...
public class AdaptiveGraphManagerTest extends JobGraphGeneratorTestBase {
    ...
    void testManagedMemoryFractionForUnknownResourceSpec() throws Exception {
        ...
        // Since the job graph is generated in a progressive way and cannot obtain global
        // information, for map2, it only contains information about Python Fraction, so the
        // value should be 1.0.
